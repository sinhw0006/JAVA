...
public class C09분산Tx {
	...
	public static void main(String[] args) throws Exception{
        ...
        xaDataSource2.setUrl("jdbc:mysql://localhost:3306/test2db");
        ...
        try {
            ...
            PreparedStatement pstmt4 = conn2.prepareStatement("INSERT INTO tbl_std values('a','1','1')");
            pstmt4.executeUpdate();
            PreparedStatement pstmt5 = conn2.prepareStatement("INSERT INTO tbl_std values('b','2','2')");//!!!!!!!!!!!
            pstmt5.executeUpdate();
            PreparedStatement pstmt6 = conn2.prepareStatement("INSERT INTO tbl_std values('c','3','3')");

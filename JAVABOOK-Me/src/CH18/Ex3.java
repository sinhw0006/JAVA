...
//			i=1			|(4-2) - 0| => 2				(1 * 2) - max(0, 4 * (1 - 4 + 1)) + 1 => 2 - 0 + 1 => 3
//			i=2			|(4-3) - 0| => 1				(2 * 2) - max(0, 4 * (2 - 4 + 1)) + 1 => 4 - 0 + 1 => 5
//			i=3			|(4-4) - 0| => 0				(3 * 2) - max(0, 4 * (3 - 4 + 1)) + 1 => 6 - 0 + 1 => 7 
//			i=4			|(4-5) - 0| => 1				(4 * 2) - max(0, 4 * (4 - 4 + 1)) + 1 => 8 - 4 + 1 => 5
//			i=5			|(4-6) - 0| => 2				(5 * 2) - max(0, 4 * (5 - 4 + 1)) + 1 => 10- 8 + 1 => 3
//			i=6			|(4-7) - 0| => 3				(6 * 2) - max(0, 4 * (6 - 4 + 1)) + 1 => 12- 12+ 1 => 1
		}
	}
}

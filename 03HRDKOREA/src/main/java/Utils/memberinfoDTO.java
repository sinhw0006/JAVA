...
public class memberinfoDTO {
	...
	public memberinfoDTO(String regist_month, String c_no, String c_name, String class_name, String class_area,
			Integer tuition, String grade) {
		super();
	...
	public String toString() {
		return "memberinfoDTO [regist_month=" + regist_month + ", c_no=" + c_no + ", c_name=" + c_name + ", class_name="
